...
export const Footer: React.FC<FooterProps> = ({ onSelectPage }) => {
  ...
  return (
    <motion.footer
      ...
      className="w-full bg-white border-t border-black/[0.08] pt-14 sm:pt-16 md:pt-20 pb-10 sm:pb-12 px-4 sm:px-6 lg:px-8 text-[#111111] font-serif"
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 pb-12 sm:pb-14">
          ...
          <div className="lg:col-span-4 flex flex-col items-start space-y-4">
            ...
            {/* Short Statement */}
            <p className="text-[14px] sm:text-[14.5px] text-[#555555] leading-relaxed max-w-sm font-sans font-normal">
            ...
            <div className="flex items-center gap-2.5 pt-1">
              <a
                ...
                className="w-9 h-9 rounded-full flex items-center justify-center text-[#222222] hover:text-black hover:bg-black/[0.04] border border-black/[0.09] hover:border-black/25 transition-all duration-200 cursor-pointer"
              >
          ...
          <div className="lg:col-span-8 grid grid-cols-2 sm:grid-cols-4 gap-8 sm:gap-6 lg:gap-8">
            ...
            <div className="flex flex-col space-y-3 sm:space-y-3.5">
              <h4 className="font-sans text-[11.5px] sm:text-[12px] font-medium text-[#111111] tracking-[0.08em] uppercase">
                ProjectVerse
              </h4>
              <ul className="space-y-2.5 text-[13.5px] sm:text-[14px] text-[#555555] font-sans">
                <li>
                  <button
                    id="footer-link-home"
                    onClick={() => handleNav('home')}
                    className="hover:text-[#111111] transition-colors duration-150 text-left cursor-pointer"
                  >
                    Home
                  </button>
                </li>
            ...
            <div className="flex flex-col space-y-3 sm:space-y-3.5">
              ...
              <div className="space-y-2 text-[13.5px] sm:text-[14px] text-[#555555] font-sans leading-relaxed">
                <div>
                  <span className="text-[11px] font-mono-code text-[#777777] uppercase tracking-wider block font-medium">Direct Inquiries</span>
                  <a
                    id="footer-contact-email"
                    href={`mailto:${CONTACT_EMAIL}`}
                    className="text-[#111111] hover:text-black font-medium transition-colors break-words text-[13.5px] underline-offset-2 hover:underline"
                  >
                    {CONTACT_EMAIL}
                  </a>
                </div>
                <div className="pt-1">
                  <span className="text-[11px] font-mono-code text-[#777777] uppercase tracking-wider block font-medium">Developer</span>
                  <a
                    href={GITHUB_URL}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#111111] hover:text-black font-medium transition-colors text-[13px] inline-flex items-center gap-1"
                  >
                    Suraj Rawat
                  </a>
                </div>
        ...
        <div className="pt-6 sm:pt-8 border-t border-black/[0.08] flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left text-[12.5px] sm:text-[13.5px] font-sans">
          {/* Left: Copyright */}
          ...
          <div className="flex items-center gap-1.5 text-[#666666]">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group relative inline-flex items-center font-medium text-[#111111] tracking-normal cursor-pointer transition-all duration-250 ease-out hover:-translate-y-[1.5px] hover:tracking-wide hover:opacity-95 focus:outline-none focus-visible:ring-1 focus-visible:ring-black"
              title="Suraj Rawat • GitHub"
            >
              <span>Suraj Rawat</span>
              {/* Subtle underline animation: 200–300ms transition */}
              <span
                className="absolute left-0 bottom-[-1.5px] w-0 h-[1px] bg-[#111111] transition-all duration-250 ease-out group-hover:w-full pointer-events-none"
                aria-hidden="true"
              />
            </a>
            <span className="text-[#999999] text-[9px] mx-1">•</span>
            <span>2026</span>
          </div>
        </div>
      </div>

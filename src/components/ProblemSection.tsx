          ...
          {problems.map((prob, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white rounded-2xl border border-black/8 shadow-xs p-6 sm:p-7 flex flex-col justify-between group hover:border-black/20 hover:-translate-y-1 transition-all duration-200"
              >
                <div>

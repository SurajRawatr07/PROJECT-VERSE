  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto flex flex-col items-center text-center">
        ...
        {/* Hero Heading: Controlled 52–64px on Desktop, 44–52px on Tablet, 34–42px on Mobile */}
        <motion.h1
          initial={{ opacity: 0, y: 14 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5, delay: 0.1, ease: [0.16, 1, 0.3, 1] }}
          className="font-serif text-[34px] sm:text-[46px] md:text-[52px] lg:text-[60px] text-[#111111] font-bold tracking-tight leading-[1.08] max-w-3xl uppercase"
        >
          Projects<br />
          Shouldn't End<br />
          With Submission.
        ...
        {/* Supporting Text: 16–18px Desktop, 15–17px Tablet, 14–16px Mobile */}
        <motion.p
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.4, delay: 0.18, ease: [0.16, 1, 0.3, 1] }}
          className="mt-5 sm:mt-6 text-[15px] sm:text-[16px] md:text-[17px] lg:text-[18px] text-[#4A4A4A] max-w-2xl leading-relaxed tracking-wide"
        >
          Discover academic projects, collaborate with the right people, get verified, and give every project a future.
        </motion.p>
